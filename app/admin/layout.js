...
// Volontairement séparé du header/footer marketing du site public : /admin
// n'affiche que sa propre navigation interne, jamais le header client (voir
// prompt "séparer la partie client... qui s'affiche en haut").
