...
async function insertPayment({ registrationId = null, groupId = null }, data, recordedByStaffId) {
  const result = await query(
    `INSERT INTO payments (registration_id, group_id, amount, currency, payment_method, notes, recorded_by_staff_id)
     VALUES (?, ?, ?, ?, ?, ?, ?)`,
    [
      registrationId,
      groupId,
