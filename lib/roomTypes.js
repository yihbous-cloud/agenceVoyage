...
// "simple" reste un type de chambre créable dans l'hébergement
// (HebergementManager.jsx, ROOM_TYPES ci-dessus, inchangé) mais n'est plus
// proposé comme préférence à l'inscription (NewRegistrationForm.jsx,
// EditRegistrationForm.jsx) — cohérent avec le fait qu'il n'a pas de palier
// de prix (voir PRICE_TIER_FIELD/pickTripPrice ci-dessous, CLAUDE.md).
export const PREFERRED_ROOM_TYPES = ROOM_TYPES.filter((t) => t !== "simple");
