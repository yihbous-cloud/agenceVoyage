...
export async function searchOffers({
  ...
  if (returnDate) {
    // Aéroports du retour indépendants de l'aller si renseignés (voir
    // CLAUDE.md) ; sinon repli sur l'aller inversé (comportement historique).
    slices.push({
      origin: returnOriginIata || destinationIata,
      destination: returnDestinationIata || originIata,
