...
export async function createSessionToken({ id, fullName, email, role }) {
  return new SignJWT({ id, fullName, email, role })
...
export const ROLES = ["direction", "ventes", "comptabilite", "suivi"];
